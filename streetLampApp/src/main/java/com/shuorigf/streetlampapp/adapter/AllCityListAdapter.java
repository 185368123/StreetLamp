...
import com.shuorigf.streetlampapp.ui.WrapHeightGridView;
import com.shuorigf.streetlampapp.util.PinyinUtils;
...
//    private int locateState = LocateState.LOCATING;
    ...
    public AllCityListAdapter(Context mContext, List<City> mCities) {
...
//                sections[index] = currentLetter;
     ...
     * @param state
     */
    public void updateLocateState(String city){
//        this.locateState = state;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        switch (viewType){
            case 0:     //定位
            	convertView = mInflater.inflate(R.layout.listitem_locate_city, parent, false);
//                ViewGroup container = (ViewGroup) convertView.findViewById(R.id.layout_locate);
                TextView state = (TextView) convertView.findViewById(R.id.tv_locate_city_value);
//                switch (locateState){
...
//                });
                break;
            case 1:     //热门
            	convertView = mInflater.inflate(R.layout.listitem_hot_city, parent, false);
                WrapHeightGridView gridView = (WrapHeightGridView) convertView.findViewById(R.id.gv_all_hot_city);
                ...
                gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        if (onCityClickListener != null){
                            onCityClickListener.onCityClick(hotCityAdapter.getItem(position));
                        }
                    }
                });
                break;
            case 2:     //所有
                if (convertView == null){
                	convertView = mInflater.inflate(R.layout.listitem_all_city, parent, false);
                    holder = new ViewHolder();
                    holder.letter = (TextView) convertView.findViewById(R.id.tv_city_letter);
